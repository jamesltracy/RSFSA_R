GlmnetBinomialQuadOrthMultiSubset.WrapperTrainTestEvalAICc <-
function(Species, VariableNamesIn, SubsetVariableNumber, TotPres, VariableSubsetsIn, SetRunID, PresenceDat.df, PseudoabsenceDat.df, BackgroundDat.df, kfoldgrpp, kfoldgrpa, polycoefsall.df, cvglmnetfoldsin, alphain, OutDirectIn, FunctDirectIn..., CVGlmnetRuns, Output, DataSetType) {
  setwd(OutDirectIn)
  library(foreach)
  library(doParallel)
