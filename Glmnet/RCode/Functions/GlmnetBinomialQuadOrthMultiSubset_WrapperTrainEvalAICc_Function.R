GlmnetBinomialQuadOrthMultiSubset.WrapperTrainEvalAICc <-
function(Species, VariableNamesIn, SubsetVariableNumber, TotPres, VariableSubsetsIn, PresenceDat.df, PseudoabsenceDat.df, BackgroundDat.df, kfoldgrpp, kfoldgrpa, polycoefsall.df, cvglmnetfoldsin, alphain, OutDirectIn, FunctDirectIn..., DataSetType, CVGlmnetRuns, Output) {
  setwd(OutDirectIn)
  library(foreach)
  library(doParallel)
