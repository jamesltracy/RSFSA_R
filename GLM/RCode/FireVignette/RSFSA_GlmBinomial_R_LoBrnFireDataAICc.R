...
## Takes 7 min for GLM Binomial AIC rerank
####################################################################################
t1 <- Sys.time()
...
OutDirectpsaAUC <- gsub("AIC", "AUC", OutDirectpsa)
setwd(OutDirectpsaAUC)
AICModelStats.df <- data.frame(read.csv(paste0(Species, "_AllWrapperTest_AICc_bg_Vs_AICc2_RegressionStats.csv"), stringsAsFactors=FALSE))
head(AICModelStats.df)
