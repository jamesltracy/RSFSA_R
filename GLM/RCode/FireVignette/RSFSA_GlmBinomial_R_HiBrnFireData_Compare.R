...
SpecFileName <- "hisevfreq1"
Species <- paste0("HiBrn")
SpecShort <- paste0("HiBr")
SpeciesGen <- "Fire"
...
Tag <- "R4"
LongSpecies <- "HiBurnSeverityLessorEqualto16yrInterval"
ClassRaster <- "mtlfallhisumr"  # name of classification raster of burn frequencies
