GLMBinomialQuadOrthMultiSubset.WrapperTrainTestEvalAICc <-
function(Species, VariableNamesIn, SubsetVariableNumber, TotPres, VariableSubsetsIn, SetRunID, PresenceDat.df, PseudoabsenceDat.df, BackgroundDat.df, kfoldgrpp, kfoldgrpa, polycoefsall.df, OutDirectIn, FunctDirectIn..., Output, DataSetType) {
  setwd(OutDirectIn)
  library(AICcmodavg)
  library(dismo)
  library(foreach)
