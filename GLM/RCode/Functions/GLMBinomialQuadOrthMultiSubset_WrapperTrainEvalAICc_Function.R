GLMBinomialQuadOrthMultiSubset.WrapperTrainEvalAICc <-
function(Species, VariableNamesIn, SubsetVariableNumber, TotPres, VariableSubsetsIn, PresenceDat.df, PseudoabsenceDat.df, BackgroundDat.df, kfoldgrpp, kfoldgrpa, polycoefsall.df, OutDirectIn, FunctDirectIn..., DataSetType, Output) {
  setwd(OutDirectIn)
  library(AICcmodavg)
  library(dismo)
  library(foreach)
